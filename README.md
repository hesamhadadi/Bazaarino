...
## ⚙️ تنظیمات ایمیل برای اطلاع‌رسانی وضعیت آگهی

برای ارسال ایمیل به صاحب آگهی بعد از تأیید/رد شدن، این متغیرها را در محیط اجرا تنظیم کنید:

- `SMTP_HOST`
- `SMTP_PORT` (مثلاً `587` یا `465`)
- `SMTP_SECURE` (`true` برای TLS مستقیم، در غیر این صورت `false`)
- `SMTP_USER`
- `SMTP_PASS`
